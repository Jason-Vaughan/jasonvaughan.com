...
export default function App() {
  ...
  const [visitorType, setVisitorType] = useState(() => {
    ...
    // Default to empty string for organic visitors so they see the clean welcome bar
    return "";
  });
  ...
  return (
    <div className="min-h-screen text-zinc-100" style={{ background: "#09090b", color: "#f4f4f5" }}>
      ...
      >
        ...
        {/* Prominent AI Virtual Interview CTA Button right under Name */}
        <motion.div
        ...
        >
          <button
            onClick={() => handleAskChatbot("Let's start a virtual interview")}
            style={{
              display: "inline-flex",
              alignItems: "center",
              gap: 10,
            ...
            onMouseEnter={(e) => {
              ...
              e.currentTarget.style.boxShadow = "0 6px 28px rgba(245, 158, 11, 0.6)";
            }}
            onMouseLeave={(e) => {
          ...
          >
            ...
            <span>Launch Interactive AI Virtual Interview</span>

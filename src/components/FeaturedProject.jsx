...
export default function FeaturedProject() {
  ...
  useEffect(() => {
    registerSection("tilt", () => setOpen(true), () => setOpen(false));
    return () => unregisterSection("tilt");
  }, []);

  useEffect(() => {
    if (window.location.hash.slice(1) === "tilt") setOpen(true);
  }, []);
        ...
        >
          ...
          <div style={{ padding: 32 }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 14, flexWrap: "wrap", cursor: "pointer", userSelect: "none" }} onClick={() => setOpen(!open)}>
              ...
              <ShareLink id="tilt" compact style={{ marginLeft: "auto" }} />
              <svg 
                viewBox="0 0 24 24" 
                fill="none" 
                style={{

...
**What happened:** Integrated the new Kobold edge node, aligned the card layout, built a custom interactive playground utility for watermark design proofing of Kobold, RentalClaw, Volta, and TiLTClaw, and implemented the watermark background on Kobold and RentalClaw. All changes successfully tested and merged (PRs #114 through #124).

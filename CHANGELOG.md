...
- **Implemented dynamic persona-specific taglines and AI-Native header badges** — configured the main landing page header to render bio/taglines customized to each active visitor persona. Added a premium, gradient-branded "AI-NATIVE" highlight badge that calls out Jason's deep AI engineering passion, aligning his introduction with the active persona.

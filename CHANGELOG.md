...
- **Enhanced watermark smoke test for agent proofing** — updated `public/smoke-test.html` to support toggling between Kobold, RentalClaw, Volta, and TiLTClaw. The tool updates all layout copy, tags, watermark assets, and color variables dynamically. Copied transparent Volta and TiLTClaw logo assets to playground static folders. Converted and deployed the new transparent V icon for Volta (`20260714-192822-v-for-volta`) as the active logo asset, and updated TiLTClaw to use its official high-res banner logo (`TiLTClaw-Banner-bigger.png`).

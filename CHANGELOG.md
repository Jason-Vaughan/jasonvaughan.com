...
- **Corrected budget and vendor claims for Google ETT role** — corrected inaccurate claims of directly managing or forecasting $15M+ budgets and managing vendor contracts/selection in `public/chat-context.json`, `src/data/career.js`, `src/data/portfolioItems.js`, and `src/components/PortfolioModal.jsx`. Reframed to accurately state that Jason managed capacity planning, contractor lifecycles, and contractor onboarding on programs ranging from $15M to $250M.
